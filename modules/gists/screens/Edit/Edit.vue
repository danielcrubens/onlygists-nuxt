<template>
  ...
  <div class="flex gap-2">
    <Button @click="handleUpdateGist" :loading="loading" class="mt-5 w-full md:w-auto" label="Criar" icon="pi pi-plus"
      icon-pos="right" />
    <Button @click="handleDeleteGist" :loading="loadingDelete" class="mt-5 w-full md:w-auto" label="Delete"
      severity="danger" />
  </div>
</template>
